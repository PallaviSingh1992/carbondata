...
object BenchMarkingUtil {
  ...
  val queries: Array[Query] = Array(
    ...
    /*  Query("SELECT count(*) as count FROM NATION","",""),
  Query("SELECT count(*) as count FROM REGION","",""),
  Query("SELECT count(*) as count FROM PART","",""),
  Query("SELECT count(*) as count FROM SUPPLIER","",""),
  Query("SELECT count(*) as count FROM PARTSUPP","",""),
  Query("SELECT count(*) as count FROM CUSTOMER","",""),
  Query("SELECT count(*) as count FROM ORDERS","",""),
  Query("SELECT count(*) as count FROM LINEITEM","","")*/
